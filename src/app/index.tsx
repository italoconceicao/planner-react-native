...
export default function Index() {
    ...
    return (
        <View className="flex-1 items-center justify-center px-5">
            ...
            <Text className="text-zinc-400 font-regular text-center mt-3">Convide seus amigos e planeje sua{"\n"}próxima viagem</Text>
            ...
            <View className="w-full bg-zinc-900 p-4 rounded-xl my-8 border border-zinc-800">
                ...
                <Button onPress={handleNextStepForm}>
                    <Button.Title>
                        {stepForm === StepForm.TRIP_DETAILS ? "Continuar" : "Continuar Viagem"}
                    </Button.Title>
            ...
            <Text className="text-zinc-500 font-regular text-center text-base">
                Ao planear sua viagem pela plann.er você automaticamente concorda com nossos <Text className="text-zinc-300 underline">termos de uso e políticas de privacidade.</Text>
            </Text>
